...
./bin/juleson template run --template modular-restructure --project ./my-project

# Use custom parameters
./bin/juleson template run --template layered-architecture \
  --project ./my-project \
...
```bash
# Create new template
./bin/juleson template create --name "my-custom-template" \
  --category "custom" \
  --description "My custom automation template"

# Edit template
./bin/juleson template edit --name "my-custom-template"
```
...
./bin/juleson template show --name modular-restructure

# Validate template
./bin/juleson template validate --name modular-restructure

# Import template from URL
./bin/juleson template import --url https://example.com/template.yaml
```
